...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
__webpack_require__("client\\init.js");
__webpack_require__("lib\\framework-init.js");
__webpack_require__(13); //loads all files in the src folder.
...
var map = {
	"./home": "..\\example\\src\\home.js",
	"./home.html": "..\\example\\src\\home.html",
	"./home.js": "..\\example\\src\\home.js",
	"./index": "..\\example\\src\\index.js",
	"./index.html": "..\\example\\src\\index.html",
	"./index.js": "..\\example\\src\\index.js"
};
...
var map = {
	"./init": "client\\init.js",
	"./init.js": "client\\init.js",
	"./loader": "client\\loader.js",
	"./loader.js": "client\\loader.js",
	"./router": "client\\router.js",
	"./router.js": "client\\router.js"
};
function webpackContext(req) {
	return __webpack_require__(webpackContextResolve(req));
};
...
var map = {
	...
	"./binding.js": "lib\\binding.js",
	"./dependency-injection": "lib\\dependency-injection.js",
	"./dependency-injection.js": "lib\\dependency-injection.js",
	"./framework": "lib\\framework.js",
	"./framework-init": "lib\\framework-init.js",
	"./framework-init.js": "lib\\framework-init.js",
	"./framework.js": "lib\\framework.js",
	"./parser": "lib\\parser.js",
	"./parser.js": "lib\\parser.js",
	"./router": "lib\\router.js",
	"./router.js": "lib\\router.js",
	"./template-compiler": "lib\\template-compiler.js",
	"./template-compiler.js": "lib\\template-compiler.js",
	"./tokenizer": "lib\\tokenizer.js",
	"./tokenizer.js": "lib\\tokenizer.js"
};
function webpackContext(req) {
	return __webpack_require__(webpackContextResolve(req));
};
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__router__ = __webpack_require__("client\\router.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__loader__ = __webpack_require__("client\\loader.js");



__webpack_require__(16); //loads all files in the src folder.
/*
function ready() {
...
/* harmony export (immutable) */ __webpack_exports__["Loader"] = Loader;
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_router__ = __webpack_require__("lib\\router.js");


class Router extends __WEBPACK_IMPORTED_MODULE_0__lib_router__["BaseRouter"] {
...
/* harmony export (immutable) */ __webpack_exports__["BindingCollection"] = BindingCollection;
...
/* harmony export (immutable) */ __webpack_exports__["BindingObserver"] = BindingObserver;
...
/* harmony export (immutable) */ __webpack_exports__["BindingContext"] = BindingContext;
...
/* harmony export (immutable) */ __webpack_exports__["BindingService"] = BindingService;



/***/ }),

/***/ "lib\\dependency-injection.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony export (immutable) */ __webpack_exports__["depend"] = depend;
class Container {
  constructor() {
...
/***/ "lib\\framework-init.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
__webpack_require__(17); //loads all files in the src folder.
...
class Bootstrapper {
  ...
  checkState() {
    if (window.document || window.document.readyState === 'complete')
      ...
      window.document.addEventListener('DOMContentLoaded', e => this.initialized)
      window.addEventListener('load', e => this.initialized);
    }
  }

  initialized() {
    window.document.removeEventListener('DOMContentLoaded', e => this.initialized)
    window.removeEventListener('load', e => this.initialized)
    this._resolveLoadPromise()
  }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__tokenizer__ = __webpack_require__("lib\\tokenizer.js");
...
class Parser {
  ...
  parse(input) {
    this.tokenize = new __WEBPACK_IMPORTED_MODULE_0__tokenizer__["Tokenize"](input);
    this.token = this.tokenize.next();
    let result;
    while (this.token.type !== __WEBPACK_IMPORTED_MODULE_0__tokenizer__["tokenType"].eof) {
  ...
  parseConditional() {
    ...
    if (this.eat(__WEBPACK_IMPORTED_MODULE_0__tokenizer__["tokenType"].question)) {
      let truthy = this.parseExpression();
      this.expect(__WEBPACK_IMPORTED_MODULE_0__tokenizer__["tokenType"].colon)
  ...
  parseExprOp(left, minPrec) {
    ...
    if (prec !== null && prec > minPrec) {
      let logical = this.token.type === __WEBPACK_IMPORTED_MODULE_0__tokenizer__["tokenType"].logicalOR || this.token.type === __WEBPACK_IMPORTED_MODULE_0__tokenizer__["tokenType"].logicalAND;
  ...
  parseSubscript(base) {
    for (let computed;;) {
      if ((computed = this.eat(__WEBPACK_IMPORTED_MODULE_0__tokenizer__["tokenType"].bracketLeft)) || this.eat(__WEBPACK_IMPORTED_MODULE_0__tokenizer__["tokenType"].dot)) {
        let expr = computed ? this.parseExpression() : this.parseSubscript(this.parseIdentifier());
        if (computed) this.expect(__WEBPACK_IMPORTED_MODULE_0__tokenizer__["tokenType"].bracketRight)
        return new AccessMember(base, expr)
      }
      else if (this.eat(__WEBPACK_IMPORTED_MODULE_0__tokenizer__["tokenType"].callLeft)) {
        let args = this.parseExpressionList(__WEBPACK_IMPORTED_MODULE_0__tokenizer__["tokenType"].callRight)
  ...
  parseExprAtom() {
    ...
    switch (this.token.type) {
      case __WEBPACK_IMPORTED_MODULE_0__tokenizer__["tokenType"].name:
        return this.parseIdentifier();

      case __WEBPACK_IMPORTED_MODULE_0__tokenizer__["tokenType"].number:
      case __WEBPACK_IMPORTED_MODULE_0__tokenizer__["tokenType"].string:
        let text = this.token.text;
        this.advance();
        return new Literal(text);

      case __WEBPACK_IMPORTED_MODULE_0__tokenizer__["tokenType"]._null:
      case __WEBPACK_IMPORTED_MODULE_0__tokenizer__["tokenType"]._true:
      case __WEBPACK_IMPORTED_MODULE_0__tokenizer__["tokenType"]._false:
        let type = this.token.type === __WEBPACK_IMPORTED_MODULE_0__tokenizer__["tokenType"]._null ? null : this.token.type === __WEBPACK_IMPORTED_MODULE_0__tokenizer__["tokenType"]._true;
        this.advance();
        return new Literal(type);

      case __WEBPACK_IMPORTED_MODULE_0__tokenizer__["tokenType"]._undefined:
        this.advance();
        return new Literal(__WEBPACK_IMPORTED_MODULE_0__tokenizer__["tokenType"].undefined);


      case __WEBPACK_IMPORTED_MODULE_0__tokenizer__["tokenType"].braceLeft:
  ...
  parseObject() {
    ...
    let values = [];
    this.advance();
    while (!this.eat(__WEBPACK_IMPORTED_MODULE_0__tokenizer__["tokenType"].braceRight)) {
      if (!first)
        this.expect(__WEBPACK_IMPORTED_MODULE_0__tokenizer__["tokenType"].comma);
      else
        first = false;
      keys.push(this.parsePropertyName());
      let value;
      if (this.eat(__WEBPACK_IMPORTED_MODULE_0__tokenizer__["tokenType"].comma) || this.eat(__WEBPACK_IMPORTED_MODULE_0__tokenizer__["tokenType"].braceRight))
  ...
  parsePropertyName() {
    return this.token.type === __WEBPACK_IMPORTED_MODULE_0__tokenizer__["tokenType"].number || this.token.type === __WEBPACK_IMPORTED_MODULE_0__tokenizer__["tokenType"].string ? this.parseExpression() : this.parseIdentifier();
  }
...
/* harmony export (immutable) */ __webpack_exports__["Parser"] = Parser;
...
/* harmony export (immutable) */ __webpack_exports__["BinaryOperation"] = BinaryOperation;
...
/* harmony export (immutable) */ __webpack_exports__["AccessMember"] = AccessMember;
...
/* harmony export (immutable) */ __webpack_exports__["CallMember"] = CallMember;
...
/* harmony export (immutable) */ __webpack_exports__["ObjectLiteral"] = ObjectLiteral;
...
/* harmony export (immutable) */ __webpack_exports__["ConditionalExpression"] = ConditionalExpression;
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__binding__ = __webpack_require__("lib\\binding.js");
/* harmony export (immutable) */ __webpack_exports__["route"] = route;
...
/* harmony export (immutable) */ __webpack_exports__["BaseRouter"] = BaseRouter;
...
/***/ "lib\\template-compiler.js":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__parser__ = __webpack_require__("lib\\parser.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__binding__ = __webpack_require__("lib\\binding.js");


class TemplateCompiler {
  constructor() {
    this.parser = new __WEBPACK_IMPORTED_MODULE_0__parser__["Parser"]();
    this.bindings = new __WEBPACK_IMPORTED_MODULE_1__binding__["BindingCollection"]();
  }
        ...
        for (let i = 1; i < parts.length; i++) {
          ...
          if (length > -1) {
            ...
            if (curly === 0 && quote === null && length > 0) {
              ...
              if (!binding)
                binding = this.bindings.add(new __WEBPACK_IMPORTED_MODULE_1__binding__["BindingContext"](expression, context));
              binding.addObserver(new __WEBPACK_IMPORTED_MODULE_1__binding__["BindingObserver"](node, "textContent"));
    ...
    if (node.nodeType < 3 && node.hasAttributes()) {
      for (let a of node.attributes) {
        ...
        if (bindingAttr.length > 1) {
          ...
          binding.addObserver(new __WEBPACK_IMPORTED_MODULE_1__binding__["BindingObserver"](node, attr));
...
/* harmony export (immutable) */ __webpack_exports__["TemplateCompiler"] = TemplateCompiler;
...
/* harmony export (immutable) */ __webpack_exports__["Tokenizer"] = Tokenizer;
...
/* harmony export (immutable) */ __webpack_exports__["TokenType"] = TokenType;
